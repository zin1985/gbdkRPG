...
static const SkillSparkEdge skill_spark_edges[] = {
    ...
    /* Axe branch. Starter AXE_TOMAHAWK has no prereq. */
    { SKILL_NONE,             SKILL_AXE_TOMAHAWK,      SPARK_CAT_TECH_AXE,  10u,  8u, SPARK_EDGE_FLAG_TECH },
    { SKILL_AXE_TOMAHAWK,     SKILL_AXE_CLEAVE,        SPARK_CAT_TECH_AXE,  16u,  9u, SPARK_EDGE_FLAG_TECH },
    { SKILL_AXE_CLEAVE,       SKILL_AXE_GIGANT,        SPARK_CAT_TECH_AXE,  26u,  6u, SPARK_EDGE_FLAG_TECH },
    { SKILL_AXE_CLEAVE,       SKILL_AXE_QUAKE,         SPARK_CAT_TECH_AXE,  22u,  6u, SPARK_EDGE_FLAG_TECH | SPARK_EDGE_FLAG_ALL_TGT },
    /* Lance branch. Starter LANCE_THRUST has no prereq. */
    { SKILL_NONE,             SKILL_LANCE_THRUST,      SPARK_CAT_TECH_SPEAR,  8u,  9u, SPARK_EDGE_FLAG_TECH },
    { SKILL_LANCE_THRUST,     SKILL_LANCE_PIERCE,      SPARK_CAT_TECH_SPEAR, 14u,  9u, SPARK_EDGE_FLAG_TECH },
    { SKILL_LANCE_PIERCE,     SKILL_LANCE_DRAGON,      SPARK_CAT_TECH_SPEAR, 26u,  6u, SPARK_EDGE_FLAG_TECH },
    { SKILL_LANCE_PIERCE,     SKILL_LANCE_TEMPEST,     SPARK_CAT_TECH_SPEAR, 20u,  6u, SPARK_EDGE_FLAG_TECH | SPARK_EDGE_FLAG_ALL_TGT },
    { SKILL_LANCE_TEMPEST,    SKILL_LANCE_TYPHOON,     SPARK_CAT_TECH_SPEAR, 30u,  5u, SPARK_EDGE_FLAG_TECH | SPARK_EDGE_FLAG_ALL_TGT },
