...
static const AreaTransitionDef area_transition_defs[] = {
    ...
    { MAP_EVENT_CAVE_DOWN,    AREA_FIELD,      MSG_ENTER_DUNGEON, AREA_CAVE_1, AUDIO_TRACK_DUNGEON, 2u, 13u, DIR_DOWN_U,  MSG_ARRIVE_DUNGEON, QUEST_OP_NONE, 0u },
    { MAP_EVENT_CAVE_UP,      AREA_CAVE_1,     MSG_DUNGEON_EXIT,  AREA_FIELD,  AUDIO_TRACK_FIELD,  13u,  8u, DIR_LEFT_U,  MSG_NONE,           QUEST_OP_NONE, 0u },
    { MAP_EVENT_CAVE_DOWN,    AREA_CAVE_1,     MSG_NONE,          AREA_CAVE_2, AUDIO_TRACK_DUNGEON, 2u, 13u, DIR_DOWN_U,  MSG_NONE,           QUEST_OP_NONE, 0u },
    { MAP_EVENT_CAVE_UP,      AREA_CAVE_2,     MSG_NONE,          AREA_CAVE_1, AUDIO_TRACK_DUNGEON,13u,  2u, DIR_UP_U,    MSG_NONE,           QUEST_OP_NONE, 0u },
    { MAP_EVENT_CAVE_DOWN,    AREA_CAVE_2,     MSG_NONE,          AREA_CAVE_3, AUDIO_TRACK_DUNGEON, 2u, 13u, DIR_DOWN_U,  MSG_NONE,           QUEST_OP_NONE, 0u },
    { MAP_EVENT_CAVE_UP,      AREA_CAVE_3,     MSG_NONE,          AREA_CAVE_2, AUDIO_TRACK_DUNGEON,13u,  2u, DIR_UP_U,    MSG_NONE,           QUEST_OP_NONE, 0u },
    { MAP_EVENT_CAVE_DOWN,    AREA_CAVE_3,     MSG_NONE,          AREA_CAVE_4, AUDIO_TRACK_DUNGEON, 2u, 13u, DIR_DOWN_U,  MSG_NONE,           QUEST_OP_NONE, 0u },
    { MAP_EVENT_CAVE_UP,      AREA_CAVE_4,     MSG_NONE,          AREA_CAVE_3, AUDIO_TRACK_DUNGEON,13u,  2u, DIR_UP_U,    MSG_NONE,           QUEST_OP_NONE, 0u },
    { MAP_EVENT_CAVE_TO_EAST, AREA_CAVE_4,     MSG_DUNGEON_EXIT,  AREA_FIELD_EAST, AUDIO_TRACK_FIELD, 2u, 14u, DIR_RIGHT_U, MSG_NONE,          QUEST_OP_NONE, 0u },
    { MAP_EVENT_CAVE_DOWN,    AREA_FIELD_EAST, MSG_ENTER_DUNGEON, AREA_CAVE_4, AUDIO_TRACK_DUNGEON,13u,  2u, DIR_UP_U,    MSG_NONE,           QUEST_OP_NONE, 0u },
    { MAP_EVENT_EAST_TOWN,    AREA_FIELD_EAST, MSG_ENTER_TOWN,    AREA_EAST_TOWN, AUDIO_TRACK_TOWN, 2u, 13u, DIR_DOWN_U, MSG_ARRIVE_TOWN, QUEST_OP_NONE, 0u },
    { MAP_EVENT_EAST_TOWN_EXIT, AREA_EAST_TOWN, MSG_BACK_FIELD,   AREA_FIELD_EAST, AUDIO_TRACK_FIELD, 13u, 2u, DIR_RIGHT_U, MSG_LEFT_FIELD, QUEST_OP_NONE, 0u }
};
