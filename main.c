...
static void player_run(void) {
    ...
    if (roll < chance) {
        dialogue_message("うまく\nにげだした！");
        battle_state = BSTATE_ESCAPE;
    } else {
        dialogue_message("にげられない！");
        battle_state = BSTATE_ENEMY;
    }
}
